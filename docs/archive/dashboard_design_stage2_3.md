# Dashboard redesign — Stage 2/3 work (ARCHIVED)
...
frontend-design skill, and the emoji→Material/native swap. This file parked the data-presentation and
polish work. The token vocabulary it refers to (colors, fonts, `chart*Colors`) lives in
