...
> **Status: SHIPPED 2026-07-05** (merged to devel in `84c3342`; owner-live-checked after
> Phase R, 2026-07-16). Checkboxes were not maintained during execution — the record is the
> archived lane brief `docs/archive/dashboard-ux.md`.
>
