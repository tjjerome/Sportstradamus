...
```bash
poetry run savant-fetch list
poetry run savant-fetch run --season 2026 --dry-run
poetry run savant-fetch run --season 2026 --only player_expected_stats
poetry run savant-fetch verify --season 2026
```
