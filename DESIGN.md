...
represented — fixed in place; a slip leg beyond that cut still burns as a star, in the place the
deeper lens would give it; selecting a leg never moves a star, it only lights it up. A leg in the
