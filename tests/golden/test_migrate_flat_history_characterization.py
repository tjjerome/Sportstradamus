    ...
    return pd.DataFrame(
        [
            {"Player": "P1", "League": "NBA", "Date": "2026-05-04", "Market": "points",
             "Line": 18.5, "Boost": 1.0, "Platform": "Underdog", "Bet": "Over",
             "Model": 0.60, "Books": 0.55, "Team": "BOS", "Model EV": 0.10, "Dist": "Poisson"},
            {"Player": "P1", "League": "NBA", "Date": "2026-05-04", "Market": "points",
             "Line": 20.5, "Boost": 2.0, "Platform": "Underdog", "Bet": "Under",
             "Model": 1.10, "Books": 1.00, "Team": "BOS", "Model EV": 0.12, "Dist": "Poisson"},
            {"Player": "P1", "League": "NBA", "Date": "2026-05-04", "Market": "points",
             "Line": 18.5, "Boost": 1.0, "Platform": "Underdog", "Bet": "Over",
             "Model": 0.62, "Books": 0.56, "Team": "BOS", "Model EV": 0.15, "Dist": "Poisson"},
            {"Player": "P1", "League": "NBA", "Date": "2026-05-04", "Market": "points",
             "Line": np.nan, "Boost": 1.0, "Platform": "Sleeper", "Bet": "Over",
             "Model": 0.50, "Books": 0.50, "Team": "BOS", "Model EV": 0.0, "Dist": "Poisson"},
            {"Player": "P2", "League": "NBA", "Date": "2026-05-04", "Market": "rebounds",
             "Line": 8.5, "Boost": 1.0, "Platform": "Sleeper", "Bet": "Over",
             "Model": 0.58, "Books": 0.52, "Team": "MIA", "Model EV": 0.05, "Dist": "Poisson"},
        ]
    )
...
def test_migrate_flat_history_normalizes_offers():
    ...
    assert list(out.columns) == [
        "Player", "League", "Date", "Market", "Offers", "Team", "Model EV", "Books EV",
        "Dist", "CV", "Model Param", "Gate", "Temperature", "Disp Cal", "Step", "Actual",
    ]
