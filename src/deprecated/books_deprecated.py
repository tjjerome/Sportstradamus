# ARCHIVED 2026-04-21 from src/sportstradamus/books.py
# Reason: Direct-book scrapers superseded by `moneylines.get_props` (which
#         consumes the consolidated odds API). Three of these (get_pp,
#         get_thrive, get_parp) had no live caller; the other four
#         (get_dk, get_fd, get_pinnacle, get_caesars) were never imported
...
#   from sportstradamus.helpers import Scrape, get_ev, get_mlb_pitchers,
#       nhl_goalies, no_vig_odds, remove_accents, requests
#   from sportstradamus.spiderLogger import logger
#   scraper = Scrape()  # module-level instance shared by all scrapers
