...
# prob_recal_platt_cv stays a registered PROB_STAGE slug but is out of the axis pool: its
# 59-dump static screen (docs/archive/researcher_passing_g1.md) did not transfer to the
