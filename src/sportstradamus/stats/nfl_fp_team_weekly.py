...
FILE_KINDS: dict[str, str] = {
    ...
    "run_pass_report_first_down": "run_pass_report_first_down.parquet",
    "run_pass_report_goalline": "run_pass_report_goalline.parquet",
    "run_pass_report_leading": "run_pass_report_leading.parquet",
    "run_pass_report_neutral": "run_pass_report_neutral.parquet",
    "run_pass_report_redzone": "run_pass_report_redzone.parquet",
    "run_pass_report_third_down": "run_pass_report_third_down.parquet",
    "run_pass_report_trailing": "run_pass_report_trailing.parquet",
