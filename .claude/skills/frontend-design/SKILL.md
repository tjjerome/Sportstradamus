...
> **Vendored from [anthropics/skills](https://github.com/anthropics/skills) — `skills/frontend-design/SKILL.md`, Apache-2.0.**
> **Repo adaptation (Sportstradamus):** the only UI surface here is the **Streamlit dashboard**, themed through
> `.streamlit/config.toml`. [DESIGN.md](../../../DESIGN.md) is the repo-specific source of truth and **supersedes**
> the web/React-specific implementation advice below. Carry over the parts that are universal — the *Design Thinking*
